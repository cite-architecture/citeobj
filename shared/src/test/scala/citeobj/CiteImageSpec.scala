...
urn:cite2:hmt:vaimg.v1:#localJpegString#file://./images#urn:cite2:hmt:msA.v1.rights:
...
"""
  ...
  "A CiteImageAjax object" should "create strings for CITE Image Service request usable either in Ajax calls or from the command line" in {
    ...
    val expectedString = "http://www.homermultitext.org/hmt-digital/images?request=GetBinaryImage&urn=urn:cite2:hmt:vaimg.v1:VA012RN_0013"
  ...
  "A LocalJpegString object" should "create strings for paths to files in a local system usable in any environment" in {
    val directoryRoot = "./"
    val expectedPath = "./hmt/vaimg/v1/VA012RN_0013.jpg"
    val jpegSource = LocalJpegString(directoryRoot)
    assert(jpegSource.protocol == "localJpegString")
