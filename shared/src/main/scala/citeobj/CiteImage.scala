...
case class CiteImage(urn: Cite2Urn, label: String, propertyList: Vector[CitePropertyValue] = Vector.empty, caption: String, rights: String, binaryUrl: URL) extends BaseObject with image {
